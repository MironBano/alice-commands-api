...
| [API.md](API.md) | HTTP-контракт для Android |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Ktor, PostgreSQL, publish |
| [ADMIN-UX.md](ADMIN-UX.md) | Веб-админка |
| [DATABASE.md](DATABASE.md) | Схема БД |
| [DEPLOYMENT.md](DEPLOYMENT.md) | VPS, Cloudflare, HTTPS |
| [RUNBOOK-PUBLISH.md](RUNBOOK-PUBLISH.md) | Публикация контента |
...
**Связанный app:** [AliceCommands](https://github.com/MironBano/AliceCommands)
